...
$("#show input[type='file']").on("change", function(){
	
	$("#upload-preview").uploadImagesPreview("#show", 
	{
...
$("#btn").on("click", function(){
	...
	if ($("#upload-preview").countImages() > 0)
	{
		$("#upload-preview").uploadImagesAjax("../ajax.php", {
			...
			success: function(data){$("#upload-preview").html(data); $("#show").fadeOut();},
...
<form id="show" action="" method="post" enctype="multipart/form-data">
...
<div class="text-center">
    <button type="submit" id="btn" name="post_submit" class="btn btn-default" disabled>Post Now!</button>
</div>
</form>
